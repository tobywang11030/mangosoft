...
var Index = (function () {
    return {
        ...
        getAd : function(){
            var url = "/v20/user/advert.html",$adList = $("#ul1"),key=$adList.data('key');
            if(!$adList[0]){return;}
        ...
        tipPhotoInterceptor: function () {
        	$.ajax({url: '/v20/tip_photo_interceptor.html',
                success: function (data) {
                	if(data == 1){
        ...
        tipHongniangInterceptor: function () {
        	$.ajax({url: '/v20/tip_hongniang_interceptor.html',
                success: function (data) {
                	if(data == 1){
...
$(function () {
    ...
    $("body").on('change', '#province select', function () {
        ...
        $.ajax({url: '/v20/info/require_reset.html',
    	...
    	$("#mask").addClass("hidden");
    		...
    		$.ajax({url: '/v20/info/check_hongniang_interceptor.html',
	          success: function (data) {
